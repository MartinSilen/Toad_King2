...
class CommandHandler(CommandHandlerInterface):
    ...
    def __init__(self, user_id, user_manager, location_manager, event_manager):
...
class LocationHandler(CommandHandler):
    ...
    def __init__(self, user_id, user_manager, location_manager, event_manager):
        super().__init__(user_id, user_manager, location_manager, event_manager)
...
class CommandHandlerFactory:
    ...
    def __init__(self, user_manager, location_manager, event_manager):
        self.user_manager = user_manager
        self.location_manager = location_manager
        self.event_manager = event_manager
